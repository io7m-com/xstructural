    ...
    <xsl:choose>
      <xsl:when test="s:MetaProperty[@name='com.io7m.xstructural.epub.cover']">
        <xsl:element name="item">
          ...
          <xsl:attribute name="href">
            <xsl:value-of select="concat('OEBPS/', s:MetaProperty[@name='com.io7m.xstructural.epub.cover'])"/>
          </xsl:attribute>
          <xsl:attribute name="media-type">
            <xsl:value-of select="sx:mimeOf(s:MetaProperty[@name='com.io7m.xstructural.epub.cover'])"/>
          </xsl:attribute>
        </xsl:element>
      </xsl:when>
    </xsl:choose>
