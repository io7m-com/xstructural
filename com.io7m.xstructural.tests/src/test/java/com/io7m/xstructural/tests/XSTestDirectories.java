...
public final class XSTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(XSTestDirectories.class);

  private XSTestDirectories()
  {
  ...
  {
    final var path =
      Path.of(System.getProperty("java.io.tmpdir")).resolve("xstructural");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/xstructural/tests/%s", name);
