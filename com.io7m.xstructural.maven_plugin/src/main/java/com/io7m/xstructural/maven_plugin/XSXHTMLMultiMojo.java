...
import static com.io7m.xstructural.api.XSProcessorRequestType.Stylesheet.MULTIPLE_FILE;

/**
 * The "xhtml-multi" mojo.
 */

@Mojo(name = "xhtml-multi")
public final class XSXHTMLMultiMojo extends AbstractMojo
{
  @Parameter(
    ...
    throws MojoExecutionException
  {
    ...
    try {
      ...
      requestBuilder.setStylesheet(MULTIPLE_FILE);
